...
const Rules: React.FC<RulesProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 backdrop-blur-md flex justify-center items-center z-50 p-4">
            <div className="bg-slate-900/95 border border-white/10 text-slate-200 rounded-2xl shadow-2xl p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto backdrop-blur-xl">
                <h2 className="text-3xl font-bold mb-6 text-center text-white tracking-tight">Ludo Game Rules</h2>
                
                <div className="space-y-6 pr-2">
                    <div>
                        <h3 className="text-xl font-semibold text-amber-400 mb-2">The Goal</h3>
                        <p className="text-slate-300">The goal is to get all four of your pieces from your starting base, around the entire board, and into your home triangle before anyone else.</p>
                    </div>

                    <div>
                        <h3 className="text-xl font-semibold text-amber-400 mb-2">1. Getting Started</h3>
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-amber-400 mb-2">2. Moving Your Pieces</h3>
                        <ul className="list-disc list-inside space-y-2 text-slate-300">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-amber-400 mb-2">3. Capturing and Safety</h3>
                        <ul className="list-disc list-inside space-y-2 text-slate-300">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-amber-400 mb-2">4. Winning the Game</h3>
                        <ul className="list-disc list-inside space-y-2 text-slate-300">
